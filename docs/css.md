...
| Components | `components.css` | Barrel importing `components/*.css` (panel, dialog, page-header, stream-instance-card, substep-shell, stream-timeline, forms, org-admin, stream, shared) |
...
| `pages/home.html` | `pages/home.css` | `components/dialog.css`, `components/stream.css`, `components/stream-instance-card.css`, `layout/index.css` |
