...
* DONE [#A] Expose step titles in backoffice view models
Effort: M
...
** DONE [#A] Add helpers to resolve step title
...
** DONE [#A] Extend dashboard/process DTOs with step titles
...
** DONE [#A] Wire step titles into existing builders/handlers
...
* DONE [#B] Render workflow + step near process ID in templates
Effort: S
...
** DONE [#B] Update `server/templates/backoffice_department.html`
...
** DONE [#B] Update `server/templates/backoffice_process.html`
...
* DONE [#B] Add/adjust tests to lock in behavior
Effort: S
...
** DONE [#B] Add integration-style unit test rendering real templates
...
* DONE [#C] Manual verification checklist
Effort: XS
...
** DONE [#C] Smoke-test pages with multiple workflows
