...
* WIP [#B] Turn workflow picker buttons into workflow cards with status counts
Effort: M
...
** WIP [#A] Compute “not started / started / terminated” counts per workflow for pickers
...
** TODO [#B] Render pickers as accessible card grid and style them
