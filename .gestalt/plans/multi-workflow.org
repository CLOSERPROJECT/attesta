...
* TODO [#A] Introduce workflow catalog loading from `server/config`
Effort: M
...
** TODO [#A] Replace single config path with catalog provider
...
** TODO [#B] Define catalog DTOs for templates and handlers
...
* TODO [#A] Make routes workflow-scoped (home and backoffice)
Effort: L
...
** TODO [#A] Add workflow-scoped route tree
...
** TODO [#A] Render workflow pickers for home and backoffice entrypoints
...
* TODO [#A] Persist workflow identity on processes and enforce app-level isolation
Effort: L
...
** TODO [#A] Add `WorkflowKey` to process model and store filters
...
** TODO [#A] Enforce workflow/process match in every handler
...
* TODO [#A] Extend Cerbos contract to include workflow scope
Effort: M
...
** TODO [#A] Include workflow attributes in check request and policy
...
** TODO [#B] Scope impersonation identity by workflow
...
* TODO [#B] Scope SSE channels and frontend refresh calls by workflow
Effort: M
...
** TODO [#B] Add workflow key to SSE subscriptions and refresh URLs
...
* TODO [#A] Update templates and page base contracts
Effort: M
...
** TODO [#A] Add workflow context to page base and templates
...
* TODO [#A] Complete verification and rollout/migration
Effort: S
...
** TODO [#A] Migration and fallback strategy
...
** TODO [#A] Full regression run and acceptance checklist
