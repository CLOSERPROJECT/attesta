...
* WIP [#B] Make workflow picker landing full-width and card grid responsive
Effort: S
...
** WIP [#A] Fix card sizing to target 4/3-per-row desktop, 1-per-row mobile
...
** TODO [#B] Rebuild web bundle and do a quick UI smoke check
