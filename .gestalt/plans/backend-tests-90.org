...
* WIP [#A] Update the coverage gate and keep it ergonomic
  - Effort :: S
...
* WIP [#C] Optional: keep a thin integration slice (not part of the gate)
  - Effort :: S
...
** WIP [#C] Add/maintain integration tests behind `integration` build tag
