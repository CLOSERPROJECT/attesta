...
* DONE [#A] Update Backoffice template to swap form → submitted display
  Effort: 45–60m
...
* DONE [#B] Add minimal styling for submitted values
  Effort: 20–30m
...
** DONE [#B] Style “Submitted” block in `web/src/styles.css`
...
* DONE [#B] Manual verification checklist
  Effort: 20–40m
...
** DONE [#B] Verify flows for scalar, file, and formata
