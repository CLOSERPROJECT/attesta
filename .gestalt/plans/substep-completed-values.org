...
* WIP [#A] Extend action view model with completed outputs
  Effort: 1.5–2h
...
** WIP [#A] Populate completed fields in `buildActionList`
...
* TODO [#A] Update Backoffice template to swap form → submitted display
  Effort: 45–60m
...
** TODO [#A] Render read-only “Submitted” block for `Status=done`
