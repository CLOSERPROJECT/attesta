...
* DONE [#A] Coverage enforcement + developer ergonomics
  - Effort :: S
...
** DONE [#A] Add a coverage gate command (Taskfile or script)
...
** DONE [#B] Document how to run unit vs integration tests
...
* DONE [#B] Optional: integration test slice (Docker-backed)
  - Effort :: M
...
** DONE [#B] Add integration tests for real Cerbos + Mongo interactions
